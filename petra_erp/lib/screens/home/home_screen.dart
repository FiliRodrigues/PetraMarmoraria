      ...
      children: [
        ...
        Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 6),
            _Chip(icon: LucideIcons.calendarCheck, label: 'Entrega hoje', value: '$hojeCount',    color: AppColors.staleWarn,
              active: _onlyHoje,
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppTheme.radiusXl),
                    borderSide: const BorderSide(color: AppColors.border)),
                  filled: true,
